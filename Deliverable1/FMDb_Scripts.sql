...
-- Below is the Initial Data for the database. There are 211 movies/series in the database. Used Python scripts and API calls to extract the data from TMDB and make the sql insert statements.
