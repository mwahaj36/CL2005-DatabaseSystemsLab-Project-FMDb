...
import MovieCard from '@/components/MovieCard'; // Assuming you already have this component
...
export default function EditProfile() {
  ...
  const [background, setBackground] = useState("");  // New state for background image
  ...
  const favoriteMovieDetails = favoriteMovies.map(movieId => 
  ...
  return (
    ...
    >
      ...
      <Navbar />
      <section id="edit-profile" className="relative">
...
<div className="w-full md:w-2/3">
  ...
  <div className="w-1/2">
    ...
    <div className="flex justify-end space-x-4">
      ...
      <a href="profile.html" type="button" className="px-4 py-2 font-bold bg-purpleWhite text-darkPurple rounded-lg">Cancel</a>
      <a href="profile.html" type="submit" className="px-4 py-2 font-bold bg-purple text-white rounded-lg">Save Changes</a>
    </div>
  </form>
</div>
