...
export default function ChangePasswordPage() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="container flex flex-col justify-center -mt-20 items-center px-6 mx-auto space-y-10">
          <h1 className="text-white text-5xl font-bold text-center">Change Password</h1>
          <form
            onSubmit={handleChangePassword}
            className="w-full max-w-md bg-purpleWhite bg-opacity-80 px-6 py-8 rounded-3xl space-y-6 drop-shadow-xl"
          >
            <input
              type="password"
              ...
              className="block w-full bg-white text-darkPurple border-2 border-purpleWhite rounded-lg py-3 px-4 focus:outline-none focus:bg-purpleWhite focus:border-darkPurple"
              required
            />
            <input
              type="password"
            ...
            <div className="mt-2 text-center">
              <a
                href="/EditProfile"
                className="text-purpleWhite text-lg hover:text-purple font-bold"
              >
                Back
              </a>
            </div>
